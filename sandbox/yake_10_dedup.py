...
language = "en"
max_ngram_size = 3
deduplication_threshold = "Variable"
...
experiment_name = "YAKE - dedupLim"
experiment_parameter = 'dedupLim'
...
notes = """Iterating through thresholds 0-1, with step .1"""
