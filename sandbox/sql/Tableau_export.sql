SELECT source.show_id_1, source.show_id_2, source.similarity, 'source' as Type, xy.x as X, xy.Y as Y, meta.show_name as Name
...
UNION
SELECT target.show_id_1, target.show_id_2, target.similarity, 'target' as Type, xy.x as X, xy.Y as Y, meta.show_name as Name
